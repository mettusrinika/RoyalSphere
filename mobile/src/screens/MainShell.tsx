...
import {Bot,CalendarDays,Compass,Home,Search,Sparkles,UserRound} from "lucide-react-native";
...
type Tab="Home"|"Explore"|"OMI"|"Bookings"|"Account";
type Overlay={type:"service";serviceId:string}|{type:"booking-create";service:any}|{type:"booking-detail";bookingId:string}|{type:"payments"}|{type:"notifications"}|{type:"conversations"}|{type:"chat";conversationId:string}|{type:"vendor"}|{type:"saved"}|{type:"review";bookingId:string}|null;
const tabs=[["Home",Home],["Explore",Compass],["OMI",Bot],["Bookings",CalendarDays],["Account",UserRound]] as const;
